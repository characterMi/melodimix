...
self.addEventListener("fetch", (event) => {
  ...
  if (eventUrl.host === self.location.host) {
    // static files generated by Next.js (Fonts, CSS) + cached files in assets
    if (
      eventUrl.pathname.startsWith("/_next/static/media") ||
      eventUrl.pathname.startsWith("/_next/static/css") ||
    ...
    // (JS) || images generated by Next.js
    if (
      eventUrl.pathname.startsWith("/_next/static/chunks") ||
...
async function cacheOnly(req, cacheName) {
  ...
  return fetchReq(req, cache, /* returnFallback= */ true);
}
